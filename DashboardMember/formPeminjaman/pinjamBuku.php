...
<body>
            ...
            <form action="" method="post">
               ...
               <div class="input-group mb-3 mt-3">
                  ...
                  <div class="input-group mb-3 mt-3">
                     ...
                     <input type="date" name="tgl_peminjaman" id="tgl_peminjaman" class="form-control" placeholder="id buku" aria-label="tgl_peminjaman" aria-describedby="basic-addon1" readonly required>
                  </div>

                  <div class="input-group mb-3 mt-1">
                     <span class="input-group-text" id="basic-addon1">Tenggat Pengembalian</span>
                     <input type="date" name="tgl_pengembalian" id="tgl_pengembalian" class="form-control" placeholder="tgl_pengembalian" aria-label="tgl_pengembalian" aria-describedby="basic-addon1" readonly required>
                  </div>
                  <div class="input-group mb-3 mt-1">
   ...
   <script>
      function setPrice() {
         ...
         } else if (selectedPaket === 0) {
            const valueTglPengembalian = document.getElementById('tgl_pengembalian').value
