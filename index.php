...
<body>
   ...
   <section id="homeSection" class="p-3">
      <div class="d-flex flex-wrap justify-content-center">
         <div class="col mt-5">
            <h2 class="fw-bold text-success"><span class="text-primary">Need</span>Perpus</h2>
      ...
      <div id="carouselExampleControlsNoTouching " class="carousel slide" data-bs-touch="false">
         <div class="carousel-inner">
            <div class="carousel-item active">
               <img src="./assets/NeedPerpus Public Library.png" class="d-block w-100 rounded" alt="...">
            </div>
            <div class="carousel-item">
               <img src="./assets/NeedPerpus - Where Every Book Holds a Universe..png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
